 ...
 */
 class DBScaSqlite extends SQLiteOpenHelper {
    ...
    private static String[] queries = new String[] {
            "CREATE TABLE user (idusuario INTEGER, idproyecto INTEGER, nombre, TEXT, base_datos TEXT, descripcion_database TEXT, user TEXT, pass TEXT, empresa TEXT, logo INTEGER, imagen BLOB, tipo_permiso INTEGER, idorigen INTEGER, idtiro INTEGER, token TEXT)",
